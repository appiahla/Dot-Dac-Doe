...
public class MultiplayerGameOpposite extends AppCompatActivity implements PlayersStateView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView player1 = findViewById((R.id.player1_circle_mult3));
        ImageView player2 = findViewById(R.id.player2_circle_mult3);
        colorOne  = getResources().getColor(R.color.black);
        colorTwo = getResources().getColor(R.color.black);
        ImageView Icon1 = findViewById(R.id.player1_icon_mult3);
        ImageView Icon2 = findViewById(R.id.player2_icon_mult3);
    ...
    public void setWinner(final Player winner) {
        Intent i = new Intent(MultiplayerGameOpposite.this, winner_page.class);
