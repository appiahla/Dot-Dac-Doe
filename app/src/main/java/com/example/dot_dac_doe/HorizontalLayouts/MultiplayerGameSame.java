...
public class MultiplayerGameSame extends AppCompatActivity implements PlayersStateView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView player1 = findViewById((R.id.player1_circle_mult2));
        ImageView player2 = findViewById(R.id.player2_circle_mult2);
        colorOne  = getResources().getColor(R.color.black);
        colorTwo = getResources().getColor(R.color.black);
        ImageView Icon1 = findViewById(R.id.player1_icon_mult2);
        ImageView Icon2 = findViewById(R.id.player2_icon_mult2);
        ...
        currentPlayerPointer1 = findViewById(R.id.playerNowPointer1_mult2);
        currentPlayerPointer2 = findViewById(R.id.playerNowPointer2_mult2);
        currentPlayerPointer2.setVisibility(View.INVISIBLE);

        ImageView pause = findViewById(R.id.multiplayer_pause2);
...
//        alert for pause menu
        View view = getLayoutInflater().inflate(R.layout.activity_hori_pause_menu, null);
...
//        alert for exit options
        View exitView = getLayoutInflater().inflate(R.layout.activity_hori_exit_confirmation, null);
        ...
        yes.setOnClickListener(view16 -> {
            exitAlert.dismiss();
            Intent i = new Intent(MultiplayerGameSame.this, HomeActivity.class);
        ...
        howto.setOnClickListener(view12 -> {
            Intent i = new Intent(MultiplayerGameSame.this, tutorial_page.class);
            startActivity(i);
        });
        ...
        restart.setOnClickListener(view1 -> {
            alert.dismiss();
            Intent i = new Intent(MultiplayerGameSame.this, MultiplayerGameSame.class);
            i.putExtra("icon1", getIntent().getStringExtra("icon1"));
